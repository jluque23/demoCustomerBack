...
public class CustomerController {
    ...
    public ResponseEntity<?> findCustomerById(@PathVariable(value = "id") Long id) {
        ...
        if ( customer == null){
            response.put("mensaje", "The ID customer: ".concat(id.toString().concat(" Doesn't exist on the database")));
    ...
    @PostMapping
    public ResponseEntity<?> saveUser(@Validated @RequestBody Customer customer) {
